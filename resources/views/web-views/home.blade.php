...
@section('title', $web_config['name']->value.' '.\App\CPU\translate('Buy Best Home Decor Products Online in The Allchemy @ Upto 35% OFF').' | '.$web_config['name']->value.' '.\App\CPU\translate(' Ecommerce'))
...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h3 class="mb-3 theading">Trending Offers </h3>
            </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o1.jpg")}}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o2.jpg")}}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o3.jpg")}}">
                                        
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o4.jpg")}}">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o5.jpg")}}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o6.jpg")}}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o7.jpg")}}">
                                        
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="{{asset("public/assets/front-end/offer/o8.jpg")}}">
            ...
            <div class="col-12 pl-0 pr-0">
                <a href="{{$main_section_banner->url}}"
                    ...
                    <img class="d-block footer_banner_img __inline-63" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('storage/app/public/banner')}}/{{$main_section_banner['photo']}}" style="width:100%!important;">
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="card __shadow h-100">
                        <div class="card-body">
                            <div class="row d-flex justify-content-between">
                              <center>  <div class="categories-title">
                                    <span class="font-semibold">{{ \App\CPU\translate('shop by category')}}</span>
                                </div></center>
