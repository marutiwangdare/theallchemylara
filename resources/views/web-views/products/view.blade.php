...
@php($decimal_point_settings = \App\CPU\Helpers::get_business_settings('decimal_point_settings'))
    <!-- Page Title-->
    <div class="d-flex w-100 justify-content-center align-items-center mb-3 __min-h-70px __inline-35" style="background-image:url(https://cdn.pixabay.com/photo/2016/07/08/13/37/texture-1504364_1280.jpg);height:200px;">
