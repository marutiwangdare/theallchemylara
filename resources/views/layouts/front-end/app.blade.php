...
<head>
 <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-VRD50J0YMD"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-VRD50J0YMD');
</script>
...
<!-------Web push notification------->
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyCVAwJX4f_d7dOUxVqx05eP5r88m8vG2GE",
    authDomain: "the-allchemy.firebaseapp.com",
    projectId: "the-allchemy",
    storageBucket: "the-allchemy.appspot.com",
    messagingSenderId: "420866167859",
    appId: "1:420866167859:web:aed029929f23f8c842bf46",
    measurementId: "G-03BX0ETZ06"
  };
