                ...
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                         ...
                         <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="https://theallchemy.in/categories">{{ \App\CPU\translate('All Categories')}}</a>
                        </li>
                         ...
                         <li class="nav-item">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle text-white" type="button" id="dropdownMenuButton"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 0">
                                            {{ \App\CPU\translate('Our')}}  {{ \App\CPU\translate('Portfolio')}}
                                        </button>
                                        <div class="dropdown-menu __dropdown-menu-3 __min-w-165px" aria-labelledby="dropdownMenuButton"
                                            style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                            <a class="dropdown-item" href="https://theallchemy.in/the-allchemy-home-decor.pdf">
                                                {{ \App\CPU\translate('Home')}} {{ \App\CPU\translate('Decor')}}
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="https://theallchemy.in/corporate-gift.pdf">
                                                {{ \App\CPU\translate('Corporate')}}  {{ \App\CPU\translate('Gifting')}}
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="https://theallchemy.in/Sthulas%20portfolio.pdf">
                                                {{ \App\CPU\translate('Clothing')}}  {{ \App\CPU\translate('Range')}}
                                            </a>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <!-- Search-->
                    <div class="input-group-overlay d-md-none my-3" style="right-padding:5%;left-padding:5%;">
                        <form action="{{route('products')}}" type="submit" class="search_form">
                            <input class="form-control appended-form-control search-bar-input-mobile" type="text"
                                   autocomplete="off"
                                   placeholder="{{\App\CPU\translate('search')}}" name="name">
